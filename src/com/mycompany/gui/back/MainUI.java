 ...
 */
public class MainUI extends BaseFormBack {
    ...
    public MainUI(Resources theme) {
      ...
      Toolbar t = new Toolbar(true);
        ...
        /*  Image img = theme.getImage("profile-pic.jpg");
    ...
    public Container createDishesContainer() {
       ...
       ArrayList<fournisseur> events; 
         ...
         //  boxAndPrice.addComponent(BorderLayout.EAST, delete);
          // box.addComponent(delete);
                delete.addActionListener(evt -> {
                    ServiceFour.getInstance().delete(e.getId_fournisseur());
        ...
        new MainUI(theme).show();
                ...
                // cnt.addComponent(edit);
                 //cnt.addComponent(delete);
                  edit.addActionListener(evet ->  new EditFor(e,theme).show()

                  
                  );
                     cnt.add(LayeredLayout.encloseIn(
                GridLayout.encloseIn(2,delete,edit)
...
FloatingActionButton add = FloatingActionButton.createFAB(FontImage.MATERIAL_ADD);
       add.addActionListener(evet -> new AddForm(theme).show());
    ...
    private Container createDishComponent(fournisseur d) {
     	//Label image=new Label(d.getImage());
      ...
      */  
        ...
        TextArea details = new TextArea(d.getEmail_fournisseur());
