...
public class utilisateur {
   ...
   // cle etrangé     
    ...
    public utilisateur(int id_utilisateur, String nom, String prenom, String cin, String mdp, String email, String num_tel, String date_naissance, String adresse, int id_role, int id_rest, int id_fournisseur,String Status_compte) {
    ...
    public utilisateur(String nom, String prenom, String cin, String mdp, String email, String numt_tel, String date_naissance, String adresse, int Salaire, int solde_conge, String poste_employe, int id_role, int id_rest) {
        this.nom = nom;
        this.prenom = prenom;
        this.cin = cin;
        this.mdp = mdp;
    ...
    public utilisateur(String nom, String prenom, String cin, String mdp, String email, String numt_tel, String date_naissance, String adresse, int id_role, int id_rest, int id_fournisseur ) {
        this.nom = nom;
        this.prenom = prenom;
        this.cin = cin;
        this.mdp = mdp;
...
//constructure modification
    ...
    public utilisateur(String nom, String prenom, String cin, String mdp, String email, String num_tel, String date_naissance, String adresse, int Salaire, int solde_conge, String poste_employe) {
        this.nom = nom;
        this.prenom = prenom;
        this.cin = cin;
        this.mdp = mdp;
