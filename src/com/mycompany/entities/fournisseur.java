...
public class fournisseur {
    ...
    public fournisseur( String nom_fournisseur, String matricule_fiscale, String domaine_fournisseur, String num_tel_fournisseur, String email_fournisseur, String adresse_fournisseur) {
    ...
    public fournisseur(String toString, String toString0, int i, int idUtilisateur) {
